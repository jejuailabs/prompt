...
async function main() {
  ...
  const modules = [
    ...
    // ─── Tools group ───
    {
      ...
      mainScreenSlot: 'none', entryView: 'gallery', requiresAuth: false, adminOnly: false, navGroup: 'tools',
    },
    {
      ...
      mainScreenSlot: 'none', entryView: 'lab', requiresAuth: false, adminOnly: false, navGroup: 'tools',
    },
    {
