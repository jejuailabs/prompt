...
async function main() {
  ...
  const modules = [
    ...
    },
    {
      ...
      icon: 'flask-conical', navOrder: 4, enabled: true, status: 'new',
      newUntil: new Date(Date.now() + 14 * 86400000),
    ...
    },
    {
      ...
      descKo: 'AI 자동화 도구로 아이디어를 완성하세요',
      descEn: 'Finish ideas with AI automation',
