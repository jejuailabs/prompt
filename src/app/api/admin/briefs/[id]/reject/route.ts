// POST /api/admin/briefs/[id]/reject — admin rejects a submitted brief
...
export async function POST(_req: NextRequest, { params }: RouteParams) {
  try {
    ...
    if (brief.status !== 'submitted') {
      throw new HttpError('제출 상태의 브리프만 반려할 수 있습니다', 400);
    }
    ...
    await logEvent('problem_brief.rejected', { briefId: id });
