export const AI_STUDIO_TOOLS = [
  ...
  { id: 'tool-whisper', titleKo: '음성 텍스트 변환', descKo: 'MP3·M4A 등 오디오 파일을 텍스트로 변환합니다', icon: 'headphones', status: 'new', features: ['Whisper large-v3 GPU', 'MP3·M4A·WAV·FLAC 지원', '한국어 최적화', 'SRT 자막 다운로드'] },
