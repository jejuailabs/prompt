...
const messages = {
  ko: {
    ...
    tabDrafts: '초안',
    tabPrompts: '내 프롬프트',
    tabVideoStudio: '영상 스튜디오',
    emptyVideoTitle: '영상 프로젝트가 없습니다',
    emptyVideoDesc: 'AI 영상 스튜디오에서 프롬프트 한 줄로 첫 영상을 만들어보세요',
    videoStatusEditing: '편집 중',
    videoStatusRendering: '렌더 중',
    videoStatusCompleted: '완료',
  ...
  en: {
    ...
    tabVideoStudio: 'Video Studio',
    emptyVideoTitle: 'No video projects yet',
    emptyVideoDesc: 'Create your first video with a single prompt in the AI Video Studio',
    videoStatusEditing: 'Editing',
